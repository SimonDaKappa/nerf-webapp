...
//         credentials: 'omit',
//       });
//       if (req.status != 200 || req.body == null || req.headers == null || req.headers.get('content-length') == null) {
//         throw new Error(req.status + ' Unable to load ' + req.url);
//       }
//       const rowLength = 3 * 4 + 3 * 4 + 4 + 4;
//       const reader = req.body.getReader();
//       let splatData = new Uint8Array(parseInt(req.headers.get('content-length')!));
//       let vertexCount = 0;
...
//   const update = useCallback((self: THREE.InstancedBufferAttribute | THREE.BufferAttribute) => {
